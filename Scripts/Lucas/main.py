...
from utils import select_and_rename_columns, make_cols_numeric, rescale_percentages
from imaging import create_bivariate_plot_matplotlib
import os
...
def first_intent():
    ...
    # Create Bivariate
    create_bivariate_plot_matplotlib(df, "pop_2011_prct", "talks_prct", file_name="MatplotlibBivariatePlot")
